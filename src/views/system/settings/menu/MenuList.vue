<template>
  <div class="container" style="width: 600px;">
    ...
    <el-tree :data="menus" :props="defaultProps" :expand-on-click-node="false" :filter-node-method="filterNode" ref="tree">
      <span class="custom-tree-node" slot-scope="{ node, data }">
        ...
        <span>
          ...
          <el-button :disabled="!data.folder" type="primary" size="mini" class="menuBtn" @click="showAddView(data)">添加</el-button>
    ...
    <el-dialog
      ...
      width="50%">
      <add-menu :addData="addData" @closeDialog="addDialogVisible = false" @refreshTableData="refreshTableData"></add-menu>
    </el-dialog>
    <el-dialog
      title="修改"
      ...
      width="50%">
      <edit-menu :editData="editData" @closeDialog="editDialogVisible = false" @refreshTableData="refreshTableData"></edit-menu>
    </el-dialog>
  </div>
</template>
