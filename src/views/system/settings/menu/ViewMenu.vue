<template>
  <div>
    <div>
      <el-switch v-model="switchValue" :disabled="true" active-text="目录" inactive-text="菜单"></el-switch>
    </div>
    <span>上一层级:{{viewData.meta.title}}</span>
    <div>
      <el-form :model="form" :rules="rules" ref="editForm" label-width="120px">
        <el-form-item label="路径" prop="url">
          <el-input v-model="form.url" :disabled="true" placeholder="url,例如：/views/emp/basic/EmpBasic.vue"
