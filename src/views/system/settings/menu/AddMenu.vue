<template>
  <div>
    ...
    <div>
      <span>上一层级:{{addData.meta.title}}</span>
    </div>
    <div>
      <el-form :model="addForm" :rules="rules" ref="addForm" label-width="120px">
        <el-form-item label="路径" prop="url">
          <el-input v-model="addForm.url" :disabled="urlInput"
                    placeholder="url,例如：/views/system/settings/menu/MenuList.vue" autocomplete="off"></el-input>
        </el-form-item>
