<template>
  <div class="container" style="width: 600px;">
    ...
    <el-dialog
      ...
      width="50%">
      <add-organ :addData="addData" @closeDialog="addDialogVisible = false"
                 @refreshTableData="refreshTableData"></add-organ>
    </el-dialog>
    <el-dialog
      title="修改"
      ...
      width="50%">
      <edit-organ :editData="editData" @closeDialog="editDialogVisible = false"
                  @refreshTableData="refreshTableData"></edit-organ>
    </el-dialog>
  </div>
</template>
